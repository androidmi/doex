...
public class MultipleTemperatureChart extends AbstractDemoChart {
     ...
     */
    public Intent execute(Context context, double[] xData, double[] yData) {
        ...
        setChartSettings(renderer, "Average hello", "Month", "Temperature", 0.5, 12.5, 0, 32,
        ...
        values.clear();
        values.add(yData);
        addXYSeries(dataset, new String[] {
                "Sunshine hours"
        }, x, values, 1);
